...
const HEADER =
  '<!-- AUTO-GENERATED from .codex/skills/clone-website/SKILL.md \u2014 do not edit directly.\n' +
...
// 1. Claude Code — same SKILL.md format, same $ARGUMENTS syntax
write('.claude/skills/clone-website/SKILL.md', raw);
...
write(
  ...
  `# AUTO-GENERATED from .codex/skills/clone-website/SKILL.md\n` +
    `# Run \`node scripts/sync-skills.mjs\` to regenerate.\n\n` +
